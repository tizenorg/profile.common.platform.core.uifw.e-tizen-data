...
%__mkdir_p %{buildroot}/usr/share/enlightenment/data/config/tizen-common
...
%__cp -afr default/config/tizen-common/*.cfg %{buildroot}/usr/share/enlightenment/data/config/tizen-common
...
/usr/share/enlightenment/data/config/tizen-common/*.cfg
%if %{with x}
